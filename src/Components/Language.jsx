        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-[17px] text-gray-300 leading-8 max-w-xl">
              Improve your English communication with practical speaking,
              grammar, vocabulary, reading and writing practice. Build
              confidence through interactive classroom activities and
