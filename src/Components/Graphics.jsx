        ...
        <div className="grid lg:grid-cols-2 gap-14 items-center">
          ...
          <div>
            ...
            <p className="mt-5 text-[17px] text-gray-300 leading-8 max-w-xl">
              Learn Graphic Designing from beginner to advanced level.
              Master Photoshop, Illustrator, logo design, branding,
              social media graphics and real-world client projects
